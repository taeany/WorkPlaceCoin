...
#   c) node1 mines 32 blocks, so now node 0 has 60001wopc, node 1 has 4250wopc, node2 has none.
#   d) node0 sends 601 wopc to node2, in two transactions (301 wopc, then 300 wopc).
