...
/* WorkPlaceCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "WorkPlaceCoin"
#define QAPP_ORG_DOMAIN "workplacecoin.org"
#define QAPP_APP_NAME_DEFAULT "WorkPlaceCoin-Qt"
#define QAPP_APP_NAME_TESTNET "WorkPlaceCoin-Qt-testnet"
