...
/** Utility functions used by the WorkPlaceCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render WorkPlaceCoin addresses in monospace font
...
// Parse "workplacecoin:" URI into recipient object, return true on successful parsing
