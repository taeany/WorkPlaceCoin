...
public:
    ...
    void setZWopcControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzWOPC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzWOPC_clicked();
    void on_pushButtonZWopcControl_clicked();
