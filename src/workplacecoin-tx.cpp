...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WorkPlaceCoin workplacecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  workplacecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded workplacecoin transaction") + "\n" +
                               "  workplacecoin-tx [options] -create [commands]   " + _("Create hex-encoded workplacecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded workplacecoin transaction
