...
static const CAmount OBFUSCATION_POOL_MAX = (4999.99 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 WOPC - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of workplacecoin.
