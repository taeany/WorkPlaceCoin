...
In order to support loading of multiple wallets in workplacecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is workplacecoin.cpp.
...
Changes to workplacecoin.cpp
----------------------
workplacecoin.cpp is the entry point into workplacecoin-qt, and as such, will require some minor modifications to provide hooks for
