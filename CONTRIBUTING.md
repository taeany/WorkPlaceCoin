Contributing to WorkPlaceCoin
============================

The WorkPlaceCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the WorkPlaceCoin project, and is not to be
confused with overall WorkPlaceCoin Network Protocol consensus changes.

Whether a pull request is merged into WorkPlaceCoin rests with the project merge
...
Patches that change WorkPlaceCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the WorkPlaceCoin consensus, it must have been
...
The project leader is the release manager for each WorkPlaceCoin release.
